            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('create.message')" :active="request()->routeIs('create.message')">
                        {{ __('Содать обьявление') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('show.messages')" :active="request()->routeIs('show.messages')">
                        {{ __('Мои обьявления') }}
                    </x-nav-link>
                </div>
                ...
                @if(Gate::allows('delete-admin-message'))
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <x-nav-link :href="route('admin.main')" :active="request()->routeIs('dashboard')">
